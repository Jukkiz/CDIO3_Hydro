...
$result2 = $conn->prepare("SELECT COUNT(*) AS LateWorks  FROM workphase WHERE ( NOW() > WorkPhase.End AND WorkPhase.FinishTIme IS NULL AND workphase.StartTIme IS NOT NULL) AND WorkPhase.GroupID IN (12111, 12131, 12132, 12141, 12121, 12122, 12211, 12112 )");
...
$result2 = $conn->prepare("SELECT COUNT(*) AS LateWorks  FROM workphase WHERE ( NOW() > WorkPhase.End AND WorkPhase.FinishTIme IS NULL AND workphase.StartTIme IS NOT NULL) AND WorkPhase.GroupID IN (12311, 12341, 12331, 12321, 12332, 12342, 12343 )");
$result2->execute(array());
...
$result2 = $conn->prepare("SELECT COUNT(*) AS LateWorks  FROM workphase WHERE ( NOW() > WorkPhase.End AND WorkPhase.FinishTIme IS NULL AND workphase.StartTIme IS NOT NULL) AND WorkPhase.GroupID IN (12221, 12231, 12241 )");
$result2->execute(array());
...
$result2 = $conn->prepare("SELECT COUNT(*) AS LateWorks  FROM workphase WHERE ( NOW() > WorkPhase.End AND WorkPhase.FinishTIme IS NULL AND workphase.StartTIme IS NOT NULL) AND WorkPhase.GroupID IN  (12251, 12252, 12510, 12520, 12271, 12930, 12281, 12920, 12912, 12911 )");
$result2->execute(array());
