...
area = new Array (
     { 'id':'upper_left',  'posX':0,          'posY':0,               'sizeX':width*0.5, 'sizeY':height*0.5 },
     { 'id':'upper_right', 'posX':width*0.5,  'posY':0,               'sizeX':width*0.5, 'sizeY':height*0.5},
     { 'id':'bottom_left', 'posX':0,          'posY':height*0.5, 'sizeX':width*0.5, 'sizeY':height*0.5},
     { 'id':'bottom_right','posX':width*0.5,  'posY':height*0.5, 'sizeX':width*0.5, 'sizeY':height*0.5}
);
return area;
}