...
//pit‰‰ laskea oikeasta kuvasta, mihin kohtaan ne sijoittuu suhteessa varsinaiseen kokoon jos tekee sen prosenteilla
 images = new Array(
	 {'id': '12111',	 'posX': width*0.170, 'posY': height*0.130, 'sizeX' :width*0.120, 'sizeY': height*0.120, 'img':'12111.png'},
	 {'id': '12131', 	 'posX': width*0.100, 'posY': height*0.140, 'sizeX' :width*0.080, 'sizeY': height*0.090, 'img':'12131.png'},
	 ...
	 {'id': '12121', 'posX': width*0.225, 'posY': height*0.400, 'sizeX' :width*0.040, 'sizeY': height*0.080, 'img':'12121.png'},
	 {'id': '12122',	 'posX': width*0.265, 'posY': height*0.400, 'sizeX' :width*0.060, 'sizeY': height*0.080, 'img':'12122.png'},
	 {'id': '12211',	 'posX': width*0.339, 'posY': height*0.305, 'sizeX' :width*0.060, 'sizeY': height*0.240, 'img':'12211.png'},
	 {'id': '12112',	 'posX': width*0.295, 'posY': height*0.130, 'sizeX' :width*0.050, 'sizeY': height*0.240, 'img':'12112.png'},
   {'id': '12311',	 'posX': width*0.065, 'posY': height*0.630, 'sizeX' :width*0.130, 'sizeY': height*0.120, 'img':'12311.png'},
   {'id': '12341',	 'posX': width*0.020, 'posY': height*0.860, 'sizeX' :width*0.120, 'sizeY': height*0.095, 'img':'12341.png'},
   {'id': '12331',	 'posX': width*0.160, 'posY': height*0.880, 'sizeX' :width*0.150, 'sizeY': height*0.060, 'img':'12331.png'},
   ...
   {'id': '12342',	 'posX': width*0.415, 'posY': height*0.630, 'sizeX' :width*0.100, 'sizeY': height*0.100, 'img':'12342.png'},
   {'id': '12343',	 'posX': width*0.450, 'posY': height*0.710, 'sizeX' :width*0.065, 'sizeY': height*0.090, 'img':'12343.png'},
   ...
   {'id': '12510',	 'posX': width*0.675, 'posY': height*0.500, 'sizeX' :width*0.145, 'sizeY': height*0.250, 'img':'12510.png'},
   {'id': '12520',	 'posX': width*0.630, 'posY': height*0.700, 'sizeX' :width*0.095, 'sizeY': height*0.140, 'img':'12520.png'},
   {'id': '12271',	 'posX': width*0.805, 'posY': height*0.365, 'sizeX' :width*0.095, 'sizeY': height*0.110, 'img':'12271.png'},
   {'id': '12930',	 'posX': width*0.815, 'posY': height*0.515, 'sizeX' :width*0.110, 'sizeY': height*0.080, 'img':'12930.png'},
   ...
   {'id': '12912',	 'posX': width*0.730, 'posY': height*0.790, 'sizeX' :width*0.070, 'sizeY': height*0.025, 'img':'12912.png'},
   {'id': '12911',	 'posX': width*0.750, 'posY': height*0.730, 'sizeX' :width*0.070, 'sizeY': height*0.025, 'img':'12911.png'}
   );
...
area = new Array (
     { 'id':'upper_left',  'posX':10,          'posY':10,               'sizeX':width*0.4, 'sizeY':height*0.55 },
     { 'id':'upper_right', 'posX':width*0.43,  'posY':10,               'sizeX':width*0.45, 'sizeY':height*0.5},
